...
const userToOrganizationService_1 = require("../userToOrganization/userToOrganizationService");
const userToTeamService_1 = require("../userToTeam/userToTeamService");
...
function updateUser(updatedUserInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log("\n\n\n\nupdated user made it");
            console.log(updatedUserInfo.isActive);
