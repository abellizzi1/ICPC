...
exports.updateCategory = exports.postCategory = exports.getCategoryByProbId = exports.getCategoriesByUserId = exports.getCategoriesByOrgId = exports.getAllCategories = exports.getDefaultCategories = exports.getCategoryById = void 0;
...
function updateCategory(categoryId, updatedName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let category = yield client_1.default.category.update({
                where: {
                    id: categoryId
                },
                data: {
