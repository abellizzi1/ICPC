...
exports.deleteProblemToCategory = exports.updateProblemToCategory = exports.postProblemToCategory = exports.getProblemToCategoryByProblemId = exports.getProblemToCategory = exports.getAllProblemToCategory = void 0;
...
function getProblemToCategoryByProblemId(problemid) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let problemToCategory = yield client_1.default.problemToCategory.findMany({
                where: {
                    problemId: problemid,
                }
            });
...
exports.getProblemToCategoryByProblemId = getProblemToCategoryByProblemId;
/**
 ...
 */
function updateProblemToCategory(problemId, newCategoryId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            var prevProbToCat = yield getProblemToCategoryByProblemId(problemId);
            let updatedProblem = yield client_1.default.problemToCategory.update({
                where: {
                    problemId_categoryId: {
                        problemId: problemId,
...
exports.updateProblemToCategory = updateProblemToCategory;
/**
 * Deletes a mapping
 * @param problemid
 * id of the problem
