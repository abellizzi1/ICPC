 ...
 */
function removeOrgToDiffMapping(orgId, diffId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Handle any errors that occur during database query
            console.error(`Failed to delete orgToDifficulty mapping by organizationId ${orgId}, difficultyId ${diffId}: ${error}`);
            throw new Error(`Failed to delete orgToDifficulty mapping by organizationId ${orgId}, difficultyId ${diffId}: ${error}`);
        }
    });
}
