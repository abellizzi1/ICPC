...
exports.deleteDifficulty = exports.doesDifficultyMappingExist = exports.doesDifficultyExist = exports.addNewDifficulty = exports.getDefaultDifficulties = exports.getDifficultyById = exports.getDifficultyByName = exports.getAllDifficulties = exports.getDifficultiesByUserId = exports.getDifficultiesByOrgId = void 0;
...
const organizationToDifficultyMappingService_2 = require("../organizationToDifficultyMapping/organizationToDifficultyMappingService");
 ...
 */
function addNewDifficulty(name, orgId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let diff;
            let difficultyId;
            ...
            // Handle any errors that occur during database query
            console.error(`Failed to add new difficulty by name ${name}, organizationId ${orgId}: ${error}`);
            throw new Error(`Failed to add new difficulty by name ${name}, organizationId ${orgId}: ${error}`);
        }
    });
}
