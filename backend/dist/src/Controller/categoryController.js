...
const categoryService_2 = require("../Service/categoryService");
const categoryService_3 = require("../Service/categoryService");
const categoryService_4 = require("../Service/categoryService");
const categoryService_5 = require("../Service/categoryService");
const categoryService_6 = require("../Service/categoryService");
const orgToCatMappingService_1 = require("../Service/orgToCatMappingService");
const categoryService_7 = require("../Service/categoryService");
function registerCategoryEndpoints(app) {
    ...
    */
    ...
    app.put('/category/updateCategory/:categoryId', (req, res) => __awaiter(this, void 0, void 0, function* () {
        let category = yield (0, categoryService_7.updateCategory)(Number(req.params.categoryId), req.body.name);
        res.send(category);
    }));
    /**
    Get All Categories
    ...
    */
    ...
    @return: new category
    */
    app.post('/category/postCategory/:userId', (req, res) => __awaiter(this, void 0, void 0, function* () {
        /*
            Example axios call:
            const category = {
            name: "name here"
        ...
        */
        let category = yield (0, categoryService_6.postCategory)(Number(req.params.userId), req.body.name);
        res.send(category);
    }));
    /**
    Remove Category
